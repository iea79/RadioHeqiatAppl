        ...
        screenOptions={({route}) => ({
          ...
          tabBarIcon: ({focused, image}) => {
            if (route.name === 'HomeScreen') {
              image = focused
                ? require('./assets/img/home-icon-focus.png')
                : require('./assets/img/home-icon.png');
            }
            if (route.name === 'FavoriteScreen') {
              image = focused
                ? require('./assets/img/favor-icon-focus.png')
                : require('./assets/img/favor-icon.png');
            }
            if (route.name === 'CatalogScreen') {
              image = focused
                ? require('./assets/img/cat-icon-focus.png')
                : require('./assets/img/cat-icon.png');
            }
            if (route.name === 'SearchScreen') {
              image = focused
                ? require('./assets/img/search-icon-focus.png')
                : require('./assets/img/search-icon.png');
            }
        ...
        {!liveLoader ? (
          ...
          <>
            ...
            <Tab.Screen
              ...
              listeners={() => ({
                tabPress: () => {
                  navigationRef.navigate('FavoriteScreen', {
                    screen: 'Favorite',
                  });
                },
              })}
            ...
            <Tab.Screen
              ...
              listeners={() => ({
                tabPress: () => {
                  navigationRef.navigate('CatalogScreen', {
                    screen: 'Categories',
                  });
                },
              })}
